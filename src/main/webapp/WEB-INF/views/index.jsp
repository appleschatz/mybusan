        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              ...
              <li class="jstyle"><a href="#" class="nav-link px-4 text-black" onclick="">여행지</a></li>
              <li class="jstyle"><a href="#" class="nav-link px-4 text-black" onclick="location.href='/place/list.do'">일정만들기</a></li>
              <li class="jstyle"><a href="#" class="nav-link px-4 text-black" onclick="location.href='/team/list.do'">팀</a></li>
              <li class="jstyle"><a href="#" class="nav-link px-4 text-black" onclick="location.href=''">이용방법</a></li>
            </ul>
